...
export default function GradientHero() {
  return (
    <div className="bg-orange-300 relative w-full overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <motion.h1
            ...
            className="from-orange-600/90 via-gray-900/90 to-gray-800/80 bg-gradient-to-tl bg-clip-text text-center text-4xl tracking-tighter text-balance text-transparent sm:text-5xl md:text-6xl lg:text-7xl"
          >
